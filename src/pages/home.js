...
export default function Home(){
    ...
    return (
        <div id="home-div">
            <div className="image">
                <img src={stockGolden} alt='Golden retriever smiling with black chairs in background' width='100%'></img>
            </div>

            <div className="info">
                <div className="boarding">
                    <h2> Boarding </h2>
                    <img src={stockBoard} alt='' width='100%'></img>
                ...
                <div className="daycare">
                    <h2> Daycare </h2>
                    <img src={stockDaycare} alt='' width='100%'></img>
                ...
                <div className="grooming">
                    <h2> Grooming </h2>
                    <img src={stockGroom} alt='' width='100%'></img>
